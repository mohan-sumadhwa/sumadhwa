        ...
        <div>
            ...
            <section id="about-technological-soluitions" className="">
                ...
                <div className="container">
                    ...
                    <p>
                        Technological solutions in manufacturing are revolutionizing industries worldwide. With IoT adoption soaring, the global IoT in manufacturing market is projected to reach $136.8 billion by 2026. Robotics usage is also surging, with an estimated 2.7 million industrial robots operating by 2022. Furthermore, AI applications are transforming production, with AI in manufacturing expected to reach $16.7 billion by 2026. These innovations optimize processes, improve product quality, and reduce downtime. Embracing technology not only boosts efficiency but also enables manufacturers to meet evolving consumer demands, ensuring sustained growth and competitiveness in the digital age.
                    </p>
                </div>
                                ...
                                <div className="content pt-4 pt-lg-0">
                                    ...
                                    <div className="row">
                                        <Card
                                            ...
                                            title="Industry 4.0"
                                            description="
                                            We help in integrating Industry 4.0 technologies, such as IoT, Robotics, AGVs, AI, to automate and enhance manufacturing processes and implementing smart manufacturing solutions for real-time monitoring and control
                                                "
                                        ></Card>
                                        <Card
                                            imgSrc={planningImg}
